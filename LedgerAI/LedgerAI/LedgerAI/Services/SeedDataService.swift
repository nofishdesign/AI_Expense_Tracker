...
enum SeedDataService {
    private static let defaultTestingAPIKey = "sk-Efz59MOF8XAAI4wirWQmTrziboH7q59nEzpsZxy1HLCinjgh"
    ...
    static func seedIfNeeded(context: ModelContext) throws {
        ...
        // Seed a default testing cloud model for local verification.
        // Remove/replace this key before production use.
        ...
        if let models = try? context.fetch(FetchDescriptor<CloudModelConfig>()) {
            if models.isEmpty {
                ...
                if openAIModel.apiKey.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty {
                    openAIModel.apiKey = defaultTestingAPIKey
                }
